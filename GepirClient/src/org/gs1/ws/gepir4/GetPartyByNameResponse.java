...
/**
 * <p>Java-Klasse für getPartyByNameResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="getPartyByNameResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getPartyByNameResponse", propOrder = {
    "gepirParty"
})
public class GetPartyByNameResponse {
